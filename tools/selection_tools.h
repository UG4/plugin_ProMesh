...
#define	TOOLTIP_SELECT_EDGE_BY_MIN_PERPENDICULAR_DISTANCE  "Selects the edge for which the specified coordinate is closest to its perpendicular projection onto this edge."
